...
class InformacionNucleoFamiliar {
    ...
    public function __construct($id = null, $id_usuario = null, $nombre_completo = '', $id_tipo_documento = null, $numero_documento = '', $id_parentesco = null, $id_genero = null, $fecha_nacimiento = null, $id_nivel_educativo = null, $trabaja = '', $celular = '', $creadoEl = '', $actualizadoEl = '') {
        $this->id = $id;
    ...
    public static function obtenerPorIdUsuario($idUsuario) {
        ...
        $query->execute();
        $query->bind_result($id, $id_usuario, $nombre_completo, $id_tipo_documento, $numero_documento, $id_parentesco, $id_genero, $fecha_nacimiento, $id_nivel_educativo, $trabaja, $celular, $creadoEl, $actualizadoEl);
        
        $infoFamiliar = [];
    
        while ($query->fetch()) {
            $infoFamiliar[] = new InformacionNucleoFamiliar($id, $id_usuario, $nombre_completo, $id_tipo_documento, $numero_documento, $id_parentesco, $id_genero, $fecha_nacimiento, $id_nivel_educativo, $trabaja, $celular, $creadoEl, $actualizadoEl);
        }
    ...
    public static function obtenerTodos() {
        ...
        while ($row = $result->fetch_assoc()) {
            $infoFamiliarArray[] = new InformacionNucleoFamiliar($row['id'], $row['id_usuario'], $row['nombre_completo'], $row['id_tipo_documento'], $row['numero_documento'], $row['id_parentesco'], $row['id_genero'], $row['fecha_nacimiento'], $row['id_nivel_educativo'], $row['trabaja'], $row['celular'], $row['creado_el'], $row['actualizado_el']);
        }
        $db->close();
