...
require_once '../src/controllers/SolicitudRetiroAhorroController.php';
...
$controlador = new SolicitudRetiroAhorroController();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_GET['id'])) {
        ...
        if ($resp) {
            ...
            echo json_encode(array("message" => "Solicitud de retiro de ahorro no encontrada."));
        }
        ...
        if ($resp) {
            ...
            http_response_code(404);
            echo json_encode(array("message" => "Solicitudes de retiro de ahorro no encontradas."));
        }
    } else {
